          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  "Sail into your shopping ocean 🌊",
                  style: TextStyle(color: const Color.fromARGB(255, 5, 60, 86)),
                ),
      ...
      child: BackdropFilter(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(14),
            border: Border.all(
              color: const Color.fromARGB(255, 5, 60, 86).withOpacity(0.45), // ✨ Tepi/border glass
              width: 1.2,
            ),
          ),
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Icon(
                icon,
                color: const Color.fromARGB(255, 5, 60, 86), // 🎨 ICON COLOR
              ),
              suffixIcon: suffix,
